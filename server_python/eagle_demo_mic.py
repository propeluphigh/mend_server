#
#    Copyright 2023 Picovoice Inc.tup
#
...
#    eagle_demo_mic enroll --access_key MkmcYRG6j7KaPf2uQd24hkd2xqHkhcOIXGt2cPy0s/sWa5TKHbTPMw== --output_profile_path ./
#    python eagle_websocket_server.py --access_key MkmcYRG6j7KaPf2uQd24hkd2xqHkhcOIXGt2cPy0s/sWa5TKHbTPMw== --profiles_dir ../profiles
import argparse
import contextlib
import os
import struct
